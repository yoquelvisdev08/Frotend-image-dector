      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-8 mb-8">
          ...
          <div className="w-full flex justify-center md:justify-end">
            <nav className="flex flex-row gap-10 text-base font-medium">
              <Link to="/docs" className="text-neutral-200 hover:text-white transition-colors duration-300 relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-white after:transition-all after:duration-300 hover:after:w-full">Documentación</Link>
